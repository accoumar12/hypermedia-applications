<template>
    <main id="back">
        <div class="info-group">
            <div class="arrow">
                <router-link to="/locations"><img src="~/assets/img/left-arrows.png"></router-link>
            </div>
                ...
                <div class="columna2">
                    ...
                    <div class="description-containera">
                        ...
                        <div v-else-if="activeSection === 2">
                            <p2 class="description">
                                This is the second section. Click on the button above to switch to the first section.
                            </p2>
                        </div>
                    </div>
                </div>
