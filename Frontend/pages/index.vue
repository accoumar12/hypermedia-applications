...
.container__info.container__text {
    /* ... existing styles ... */
    position: absolute;
...
.container__image-f:hover .container__info {
    opacity: 1;
}
...
.container__image-t:hover .container__info {
    opacity: 1;
}



.container__image-t:hover {
    border-radius: 0;
    width: 250px;
    height: 210px;
    opacity: 0.7;
...
.container__image-e:hover .container__info {
    opacity: 1;
}
